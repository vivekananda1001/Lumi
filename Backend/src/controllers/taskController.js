...
import { promptUser,synthesizeText } from '../../Text_to_Speech.js';
const taskController = {
  ...
  chatWithGpt: async (req, res) => {
    try {
      ...
      synthesizeText(gptResponse.description,"YourAudioFile.wav");
